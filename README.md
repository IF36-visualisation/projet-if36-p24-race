...
1. Quels pays ont exercé une domination dans l'histoire des Jeux Olympiques ?  
   ...
   > ***Nuage de points des médailles par année :*** permet d'identifier les périodes de domination ou de déclin, ainsi que les évolutions à long terme des performances olympiques des pays.
