...
```{r Question4-A,echo=FALSE,Warning =FALSE, message=FALSE,fig.align="center", fig.width = 10}
...
```
```{r echo=FALSE, fig.align="center",warning=FALSE,fig.width = 10}
...
Le graphique en barres ci-dessus présente la répartition des femmes par sport aux Jeux Olympiques. On constate que malgré le fait que les femmes sont présentes déja dans de nombreux sports tels que le figure skating, le badminton, le trampoling et le taekwendo, leur participation reste encore très minime sur la majorité des jeux. 


</br><hr width="20%" /></br>

#### Conclusion :
En somme la participation des femmes aux jeux olympiqes bien qu'encore minime, évolue au fil des années et tend à s'éqilibrer avec celui des hommes.
